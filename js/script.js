...
const members = {
    ...
    "01814843266":{
        ...
        payment             :{"04-02-24-Cash":4500},
        // running month
        stay_cost       :2200,
        garage_cost     :0,
        running_payable :2589,
        running_paid    :4500,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01922362569":{
        ...
        payment             :{"11-02-24-DBBL":2000,"15-02-24-Cash":1000,"28-02-24-Cash":1000},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :2129,
        running_paid    :4000,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01532023080":{
        ...
        post_payable        :3587,
        previous_paid       :6500,
        previous_dining_cost:2548,
        payment             :{"04-02-24-Cash":3000,"08-02-24-Bkash":500,"12-02-24-Cash":500,"17-02-24-Cash":1500,"24-02-24-Cash":1000},
        // running month
        stay_cost       :2500,
        garage_cost     :500,
    ...
    "01640454889":{
        ...
        post_payable        :2899,
        previous_paid       :6000,
        previous_dining_cost:2236,
        payment             :{"31-01-24-Cash":5000},
        // running month
        stay_cost       :2330,
        garage_cost     :0,
    ...
    "01738393696":{
        ...
        previous_paid       :6000,
        previous_dining_cost:1300,
        payment             :{"22-02-24-Cash":3100},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :3040,
        running_paid    :3100,
        running_meal    :0,
        // method calling
        preMonth,
    ...
    "01714443406":{
        ...
        post_payable        :5857,
        previous_paid       :6000,
        previous_dining_cost:1716,
        payment             :{"18-02-24-Cash":3000,"21-02-24-bKash":2000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01834648400":{
        ...
        previous_paid       :4000,
        previous_dining_cost:1300,
        payment             :{"10-02-24-iCash":5000},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :5156,
        running_paid    :5000,
        running_meal    :25,
        // method calling
        preMonth,
        ...
        if( memberNumber === "01834648400" || memberNumber === "01814843266" 
         ...
         || memberNumber === "01738393696" || memberNumber === "01714443406"){
            ...
            memberDiningList.innerHTML = `<tr>
                                            ...
                                            <tr>
                                                <td>${members["01738393696"].name}</td>
                                                <td>${members["01738393696"].runningDiningCost()}</td>
                                                <td>${members["01738393696"].runningMonth().diningAdd}</td>
                                                <td class="getMeals">${members["01738393696"].runningMonth().remainDining}</td>
                                                <td>${members["01738393696"].runningMonth().diningDue}</td>
                                            </tr>
                                            <tr>
            ...
            if(memberNumber === '01710430501'){
                ...
                costTotalCheck.innerHTML = `<tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="dining-me">${members["01925315230"].runningDiningCost()}</td>
                                                <td class="due-me">${members["01925315230"].runningMonth().diningDue}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th>${members["01738393696"].name}</th>
                                                <td class="payable">${members["01738393696"].totalPayable()}</td>
                                                <td class="paid-me">${members["01738393696"].running_paid}</td>
                                                <td class="dining-me">${members["01738393696"].runningDiningCost()}</td>
                                                <td class="due-me">${members["01738393696"].runningMonth().diningDue}</td>
                                            </tr>
                                            <tr>
